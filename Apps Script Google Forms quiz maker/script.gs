/**
 * Modèle Apps Script Google Forms – Quiz Maker (exemple 5 questions)
 *
 * ═══════════════════════════════════════════════════════════════
 * PROCÉDURE (modèle réutilisable + évite le blocage de permissions) :
 ...
 *
 * Ce script sert de modèle à fournir à une IA : donnez vos questions
 * en langage naturel et demandez-lui de générer la section `questions`
 * dans ce même format pour créer automatiquement n'importe quel QCM.
 */
...
function remplirQuiz() {
  ...
  // ── Paramètres globaux ────────────────────────────────────────────────────
  form.setTitle("QCM – Exemple (à personnaliser)");
  form.setDescription(
    "Exemple de quiz généré automatiquement via Apps Script.\n" +
    "Remplacez les questions pour votre propre sujet.\n" +
